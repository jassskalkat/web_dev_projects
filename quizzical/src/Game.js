  ...
  function toggleSelect(question, answer) {
    if (!checkingAnswers) {
      setQuestionsData((prevQuestionData) =>
        prevQuestionData.map((prevQuestion) => {
  ...
  return (
    <div>
      ...
      <div className="checkAnswers--button--container">
        {checkingAnswers && allAnswersSelected && (
          <div className="correct--answers">
            You scored {correctAnswers}/{questionsData.length} correct answers
          </div>
        )}
        {!allAnswersSelected && (
          <div className="not--all--selected">All answers must be selected</div>
        )}
        <button
          className="checkAnswers--button"
          onClick={checkingAnswers ? playAgain : checkAnswers}
        >
